...
use App\Models\Post; // Memastikan model Post dipanggil untuk mengisi database 

class PostSeeder extends Seeder
{
    public function run(): void
    {
        // Artikel 1: Belajar Laravel di Praktikum TRPL
        Post::create([
        ...
        // Artikel 2: Mengenal Kura-kura Sebagai Hewan Peliharaan
        Post::create([
