                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="/halamanbebas" :active="request()->is('halamanbebas')">HalamanBebas</x-nav-link>
                            <x-nav-link href="/detailhewan" :active="request()->is('detailhewan')">DetailHewan</x-nav-link>
        ...
        <el-disclosure id="mobile-menu" hidden class="block md:hidden">
            ...
            <div class="border-t border-white/10 pt-4 pb-3">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Oktorio Mahmud Ozy Saputra</div>
                        <div class="text-sm font-medium text-gray-400">Oktorio@gmail.com</div>
                    </div>
