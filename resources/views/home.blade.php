    ...
    <div class="min-h-full">
        <nav class="bg-gray-800">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="/halamanbebas" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Halamanbebas</a>
                                <a href="/detailhewan" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Detailhewan</a>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                <div class="space-y-1 px-2 pt-2 pb-3 sm:px-3">
                    ...
                    <a href="/halamanbebas" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Halamanbebas</a>
                    <a href="/detailhewan" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Detailhewan</a>
                </div>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <h2>Perkenalkan nama saya Oktorio Mahmud Ozy Saputra, Saya saat ini adalah Mahasiswa di <br>
                    POLMAN BABEL (Politenik Manufaktur Negri Bangka Belitung)
                </h2>
